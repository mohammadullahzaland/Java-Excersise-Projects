...
public class C03E32_PointPosition
{
  public static void main(String[] args)
  {
    ...
    System.out.println("Enter the point You want to find it's positions:");
    ...
    {
      System.out.println("the point is on the on top of the line");
    }
